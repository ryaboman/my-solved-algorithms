Вспомним нашего старого знакомого робота из task_1 задачи. Теперь мы будем давать роботу команды удаленно, подключаясь к нему по беспроводному каналу связи.
